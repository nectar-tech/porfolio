  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="px-6 md:px-[60px] pt-[80px] pb-[96px] max-w-[1100px] mx-auto w-full animate-fadeUp">
        <h1 className="text-[56px] md:text-[7vw] lg:text-[88px] font-[350] leading-[1.05] tracking-tight text-mainText max-w-[900px] mb-6">
          Hello! I'm <span className="font-black">Nectar</span>.<br />
          I'm a <span className="font-black">product designer</span>.
        </h1>
        <p className="text-xl md:text-2xl text-muted leading-[1.7] mb-10">
          Here to solve design challenges and create simple, meaningful solutions.
        </p>
      </section>
      ...
      <section
        id="projects"
        className="px-6 md:px-[60px] py-20 w-full"
      >
